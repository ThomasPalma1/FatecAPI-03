...
<table border="1">
    <tr>
     ...
     <tr>
        ...
        <td style="text-align: center; vertical-align: middle;">Tela de Cadastro dos Produtos; Tela para Cadastro de Clientes (Prospect) com informações do cliente e seu nível de interesse; Painel para visualização dos contatos.</td>
